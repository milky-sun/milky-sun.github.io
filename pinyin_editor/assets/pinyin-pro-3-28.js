(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.pinyinPro = {}));
  ...
  function middlewareOutputFormat(segments, options) {
      const { format = exports.OutputFormat.AllSegment, separator = ' ' } = options;
      if (format === exports.OutputFormat.AllSegment) {
      ...
      else if (format === exports.OutputFormat.AllArray) {
          return segments.map(item => item.segment);
      }
      else if (format === exports.OutputFormat.AllString) {
  ...
  const DEFAULT_OPTIONS = {
      ...
      toneSandhi: true,
      segmentit: 2 /* TokenizationAlgorithm.MaxProbability */,
      format: exports.OutputFormat.AllSegment,
      traditional: false,
  };
  ...
  exports.addTraditionalDict = addTraditionalDict;
  ...
  exports.getTraditionalDict = getTraditionalDict;
  exports.html = html;
  exports.match = match;
